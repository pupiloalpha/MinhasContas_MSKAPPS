...
public class CriarNovaConta extends AppCompatActivity implements
    ...
    private int nRepete, qtRepete, intervalo, nr;
    ...
    private ArrayAdapter completa, classesContas;
        ...
        AlertaCalendario
                .adicionarEventoNoCalendario(
                        ...
                        this.getString(R.string.dica_calendario,
                                String.format("%.2f", contaValor)), dia, mes,
                        ano, true);
        setResult(RESULT_OK, null);
        dbNovasContas.close();
        finish();
